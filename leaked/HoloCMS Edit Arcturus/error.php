              ...
              <div class="row">
                  <div class="col-6 offset-md-3">
                      <div class="content-box">
                          <div class="title">OH BOBBA! PÁGINA NÃO ENCONTRADA.</div>
                          <div class="box-body"><span class="float-right"><img src="<?php echo $Holo['url']; ?>/img/website/serverf.gif"></span>
                              <div style="padding-bottom: 30px;">O Frank não conseguiu encontrar a página que você estava procurando. Verifique o endereço ou volte à <a href="<?php echo $Holo['url']; ?>/">página de início</a> do <?php echo $Holo['name']; ?> Hotel.</div>
                              <a href="<?php echo $Holo['url']; ?>/" class="button button-green">Página de Início</a></div>
                      </div>
                  </div>
              </div>
          </div>
