...
<?php $onlines = mysql_query("SELECT * FROM users WHERE online = '1' ORDER BY online DESC");
while($online = mysql_fetch_array($onlines)){ ?>
		<div class="col-2">
			<a href="<?php echo $Holo['url']; ?>/home/<?php echo $online['username']; ?>" class="top-bar online-users">
				<div class="user">
					<div class="username">
						<img src="<?php echo $Holo['avatar'] . $online['look']; ?>&amp;direction=2&amp;gesture=sml">
						<span class="user-style <?php echo $online['user_style']; ?>"><?php echo mb_strimwidth($online['username'], 0, 10, "..."); ?></span>
					</div>
				</div>
			</a>
		</div>
