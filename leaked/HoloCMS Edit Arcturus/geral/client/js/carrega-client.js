...
(function() {
	function u() {
		...
		b.innerHTML = '<a href="https://get.adobe.com/flashplayer/" target="_blank"><div id="flashi"><div class="carrega-error-image"></div><div class="carrega-error"><div class="escolher-titulo">Você está quase lá!</div><div class="escolher-info">Clique aqui, e em seguida, clique em "executar flash" quando solicitado. Nos vemos no Hotel!<br><br>Se você está utilizando um iPad, iPhone ou um dispositivo Android você deve baixar o Puffin Web Browser na App Store ou na Google PlayStore para poder entrar no Hotel.</div></div>';
		h.remove();
	...
	function m() {
		if (!n) {
			...
			b.innerHTML = "Por favor aguarde! O Hotel está carregando...";
	...
	var f = [],
		q = 0,
		r = 0,
		v = new Audio("/geral/som/client.mp3");
	...
	window.addEventListener("load", function() {
		...
		if (b) {
			var b = document.createElement("div");
			a.innerHTML = '<div class="carrega-error-image"></div><div class="carrega-error"><div class="escolher-titulo">Você está quase lá!</div><div class="escolher-info">Clique aqui, e em seguida, clique em "executar flash" quando solicitado. Nos vemos no Hotel!<br><br>Se você está utilizando um iPad, iPhone ou um dispositivo Android você deve baixar o Puffin Web Browser na App Store ou na Google PlayStore para poder entrar no Hotel.</div></div>';
			h.remove();
